...
object HelloWorld {
  ...
  def main(args: Array[String]) {
    ...
    val result1 = VariableElimination.probability(wakingUp, "Oh no, not again!")
    println("Probability that today’s bedside is the left one\": " + result1)
